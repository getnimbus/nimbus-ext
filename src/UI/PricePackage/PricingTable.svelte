        ...
        <td class="py-3 pr-3">
          <div class="flex flex-col gap-2">
            ...
            <!-- <div class="w-[170px]">
              <Button>
                <div
                  class={`flex items-center gap-2 text-white font-medium xl:text-base text-sm ${
        ...
        <td class="py-3 pr-3">
          <div class="flex flex-col gap-2">
            ...
            <div
              class={`w-[170px] ${
                buyPackage === "Free" ||
                (interval === "month" && selectedTypePackage === "year")
                  ? "opacity-100"
                  : "opacity-0"
              }`}
            >
            ...
            <!-- remove me -->
            <!-- <div class="font-medium mt-5 xl:text-lg text-xl">
