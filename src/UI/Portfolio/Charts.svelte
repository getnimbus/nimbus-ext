    ...
    >
      ...
      {:else}
        <div class="flex justify-between mb-6">
          {#if ($typeWallet === "EVM" && ($chain === "SCROLL" || $chain === "KLAY" || $chain === "XZO")) || $typeWallet === "CEX" || $typeWallet === "SOL" || $typeWallet === "ALGO" || $selectedBundle?.accounts?.find((item) => item.type === "CEX") !== undefined}
            <TooltipTitle
