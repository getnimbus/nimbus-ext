    ...
    >
      ...
      {:else}
        <div class="flex justify-between mb-6">
          {#if ($typeWallet === "EVM" && $chain === "SCROLL") || $typeWallet === "CEX" || $typeWallet === "SOL" || $typeWallet === "SUI" || $typeWallet === "AURA" || $typeWallet === "ALGO" || $selectedBundle?.accounts?.find((item) => item.type === "CEX") !== undefined}
            <TooltipTitle
