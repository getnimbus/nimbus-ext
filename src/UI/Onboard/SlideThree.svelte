  ...
  <div class="h-[90%] flex flex-col justify-between items-center">
    <div class="flex-1 flex flex-col items-center justify-center gap-6">
      <div class="flex flex-col items-center gap-6">
        <div class="text-5xl font-normal">Search from any where</div>
        <div class="text-lg text_00000099 font-normal">
          Click the arrow on left right edge or use shortcut
          <span
            class="px-2 py-1.5 text-xs font-semibold text-gray-800 bg_fafafbff border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500"
          >
