...
<!-- <span
  ...
  class="mx-[0.5em] inline-block whitespace-nowrap transition-all text-sky-400 rounded-[3px] py-[2px] px-1 max-w-[8em] cursor-pointer overflow-hidden bg-sky-100 hover:max-w-[7rem] select-none"
>
  📒 <span class="font-sans">More info</span>
</span> -->
<style>
