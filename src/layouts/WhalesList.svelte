            ...
            <th class="py-3">
              ...
              >
                ...
                <div on:click={toggleSortChange30D} class="cursor-pointer">
                  {@html iconSorting(sortChange30D)}
                </div>
              </div>
            </th>
            <th class="py-3">
            ...
            <th class="py-3">
              ...
              >
                ...
                <div on:click={toggleSortVolatility} class="cursor-pointer">
                  {@html iconSorting(sortVolatility)}
                </div>
              </div>
            </th>
            <th class="py-3">
              ...
              >
                ...
                <div on:click={toggleSortMaxDrawDown} class="cursor-pointer">
                  {@html iconSorting(sortMaxDrawDown)}
                </div>
              </div>
            </th>
            <th class="py-3">
              ...
              >
                ...
                <div on:click={toggleSortSharpeRatio} class="cursor-pointer">
                  {@html iconSorting(sortSharpeRatio)}
                </div>
              </div>
            </th>
