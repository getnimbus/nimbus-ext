<script lang="ts">
  ...
  import LendingPosition from "~/UI/Portfolio/DefiPosition/LendingPosition.svelte";
  import StakePosition from "~/UI/Portfolio/DefiPosition/StakePosition.svelte";
  import BorrowPosition from "~/UI/Portfolio/DefiPosition/BorrowPosition.svelte";
  import VestPosition from "~/UI/Portfolio/DefiPosition/VestPosition.svelte";
  import AmmPosition from "~/UI/Portfolio/DefiPosition/AMMPosition.svelte";
  import ClmmPosition from "~/UI/Portfolio/DefiPosition/CLMMPosition.svelte";
  import FarmPosition from "~/UI/Portfolio/DefiPosition/FarmPosition.svelte";
