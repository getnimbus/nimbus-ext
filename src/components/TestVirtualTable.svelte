<script lang="ts">
  ...
  import { isDarkMode, typeWallet, totalAssets } from "~/store";
...
>
  ...
  >
    ...
    {#if listSupported.includes($typeWallet)}
      <div class="auto-cols-min py-3 rounded-tr-[10px]" />
    {/if}
  </div>
  ...
  {#if isLoading}
    ...
    >
      {#if isLoading}
        <div
          class="col-spans-full flex justify-center items-center h-full py-3 px-3"
        >
          <Loading />
        </div>
      {/if}
  ...
  {:else}
    <div>
      {#if data && data.length === 0}
        ...
        >
          <div
            class="col-spans-full flex justify-center items-center h-full py-3 px-3 xl:text-lg text-xl text-gray-400"
          >
        ...
        >
          ...
          >
            ...
            {#if listSelectedIndex.includes(index)}
              ...
              <div
                class={`col-span-full -mt-2 -mx-[1px] max-h-[500px] overflow-y-auto ${
